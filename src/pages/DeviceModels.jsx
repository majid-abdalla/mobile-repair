...
// import { models as initialModels, brands } from '../data/mockData'
...
//     filterFn: brandFilter ? (item) => item.brand === brandFilter : null,
//   })
...
//         action={<Button icon={IoAdd} onClick={() => { setEditing(null); setModalOpen(true) }}>Add Model</Button>}
//       />

//       <Card padding="none">
//         <div className="space-y-4 p-4 sm:p-6">
//           <div className="flex flex-col gap-3 sm:flex-row sm:items-end">
//             <SearchBar value={search} onChange={(v) => { setSearch(v); resetPage() }} placeholder="Search models..." className="flex-1" />
//             <Select
//               value={brandFilter}
...
//       <Modal open={modalOpen} onClose={() => setModalOpen(false)} title={editing ? 'Edit Model' : 'Add Model'}>
//         <ModelForm brands={brands} initialData={editing} onSubmit={handleSubmit} onCancel={() => setModalOpen(false)} />
//       </Modal>
...
//         }
//       >
//         <p className="text-sm text-slate-600">Delete model <strong>{deleting?.name}</strong>?</p>
//       </Modal>
//     </div>
//   )
// }
